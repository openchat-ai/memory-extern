...
`endif
      ...
      // SIM-BRINGUP: real RDQS/WCK-recovery clocks come from black-box analog
      // RX CC; tie to PLL phases so the RX FIFO and dfird clock chain run.
      .i_rdqs_clk_0                (i_pll_clk_0),
      .i_rdqs_clk_180              (i_pll_clk_180),
      .i_rx_sdr_clk                (i_pll_clk_0),
