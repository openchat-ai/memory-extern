// ============================================================================
// engine_core_macsplit_norst.v — 去复位归约树版（时序实验，复制自 macsplit）
//
// 改动：u_red_lo/u_red_hi 改用 reduction_tree_norst（stage 数据寄存器无复位，
//   仅 valid 链复位）。目的：消除 rst 高扇出进数据路径（RESET/rst_sync 关键路径）。
//   合并级 sum_r/sum_valid_r 保持复位（输出安全）。
//
...
module engine_core_macsplit_norst #(
