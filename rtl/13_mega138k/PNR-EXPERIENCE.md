...
## 2026-09-03 �������루Inc PnR��֧������������ �� �û�����Ҫ��¼
- **Gowin ֧������ PnR**��Incremental Place & Route����gw_sh Tcl ���SUG1220����
    - `set_option -inc_place <0|auto|file>`���������֡�0=�� / auto=�Զ� / file=ָ�� *.p ���������ļ���
    - `set_option -inc_pnr  <0|auto|file>`���������ֲ��ߡ�ȡֵͬ�ϡ�
    - ���inc_place ֻ������ǰ�β��֣�inc_pnr ����+���߶������ϴν�����ֲ�������**ʡ������ȫ���ز�**���ʺ�С�Ķ����ٵ�����
- **`.p` �ļ�**��PnR ÿ�λ��� `impl/pnr/<top>.p` �������������������� 2.7MB�������������������"�ϴβ��ֿ���"��
- **��������������ȫ���������Ч�����򹤾��˻�ȫ����ʱ�䲻ʡ��**��
    1. **����ӿ�/�����ṹ����** ���� ֻ��ģ���ڲ��߼�������/�����˿ڡ����������������Ҹ� ws2812_smoke ���� `off` �˿ڲ����� top ���� �� �ӿڱ��ˣ�**����������**��
    2. **ͬһ����Ŀ¼**�����븴���ϴι��̣����� `create_project -force` �ؽ��������������Ϣ�������� build_periph_smoke.tcl �� `-force` �ؽ� + `run all`����������ͻ��
    3. �Ķ��Ǿֲ���ӳ��/�ض�ʱ�����Ǵ�����ṹ������
- **���ν���**��wy2812 ����/��ɫ�Ķ���"�Ľӿ�+�ع�"��������ʧЧ�˻�ȫ�����ʱ�����ȫ�� PnR��**�´δ��߼�΢�������Ľӿڣ������� `set_option -inc_pnr auto`**������ȥ�� create_project �� -force ���Ϊ open ���й��̡�
## 2026-09-03 SDC ʱ��Լ����get_nets �������ۺϺ� net �� �� �û�����Ҫ��¼
- **����**��SDC �� `create_clock ... [get_nets {lcd_clk_35}]` ���� `ERROR (TA2003) ... Can't set timing constraint to object` + `TA2004: Cannot get clock with name`���ۺ���ͨ���� Placement �׶� 64s �� PnR DONE ʧ���˳���
- **����**��SDC Լ��������ȡ���� **�ۺϺ�����** ��� net �������� RTL ��� wire �����ۺ�����ѵ� bit �м����Ż�/�ϲ����������� top �� `wire lcd_clk_35; wire lcd_pix_clk = lcd_clk_35;` �ӽ� Gowin_PLL ʵ�� clkout0 �� OBUF �� ����˿ڣ��ۺϺ��������� net ������дΪ **Gowin_PLL ģ��Դ���������� `lcd_clk_d`**���� `impl/gwsynthesis/<top>.vg` �� `.CLKOUT0(lcd_clk_d)`����
- **Ϊʲô clk_200m ����**����ǡ����Ψһ������Ҳ��������ͬ�� net �Ķ���ֱ�� wire���� lcd �������� OBUF �ֿ��� module �߽磬���ֲ�ͬ��
- **��ȷ����**��ֱ�� grep �ۺϲ��� `gwsynthesis/<top>.vg` �� PLL ʵ���� `.CLKOUT0(<net>)` �õ���ʵ net ����SDC �� `[get_nets {<����>}]`�����ΰ� lcd_clk_35 ��Ϊ lcd_clk_d �� 1225s ȫ�� PnR �ɹ�����¼ OK��
- **ͨ���б�**���� create_clock �� TA2003/TA2004���� `Select-String <top>.vg -Pattern "<������>"` ȷ��������ʵ�����֣��ٸ� SDC������ RTL ��׷��

2026-09-03 ����PnR�����ӣ�CM2030���� + auto���棩
- CM2030�ı�:"Ignore incremental placement,due to specified incremental placement and routing."
- ����:���� impl/*_process_config.json �� INCREMENTAL_PLACE_ONLY ����ʷ����="auto",
  �� INCREMENTAL_PLACE_AND_ROUTING=auto ���� => ������"placement AND routing ��ָ��"=> Ignore��
- ֻɾ tcl ��� -inc_place ����:���߶��־û� config,���ǵ�ǰ�С�������ʽ set_option -inc_place 0 �������
- �޸��� CM2030 ��ʧ(�ۺϺ�PnR��ڲ��ٱ���)���� auto ģʽ�� 138K �����+�ۺ��иĶ�ʱ
  ������/��ȫ��(1515s+δ����),���κμ������� => �����Ա���Ŀʵ������,������
- ����:��PLL/����/���ʱ����ʵʵȫ��;�������ʺ���С�Ķ�(��reg)��С��Ʋ������塣
- ȫ��tcl(build_periph_smoke.tcl, -force�ؽ�)�ɿ�:����ws2812 LV 0x1A->0x06 ȫ��882s��PNR-DONE��
