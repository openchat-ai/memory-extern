...
set TOP board_top_probe
set SRC  F:/sram/sram/rtl/13_mega138k
set PROTO F:/sram/sram/rtl/12_fpga_proto/rtl
set OUT  F:/sram/sram/out/138k_pro/probe

file mkdir $OUT

create_project -name board_top_probe -dir $OUT -pn GW5AST-LV138FPG676AES -device_version B -force
set_device -device_version B GW5AST-LV138FPG676AES

# ---- 顶层 ----
add_file $SRC/board_top_probe.v
...
set_option -output_base_name board_top_probe
...
set result_file "$SRC/probe_result.txt"
