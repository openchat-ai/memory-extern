...
// %bb.2:
	...
	and	x16, x12, #0x7ffffffc
	movi	v0.2d, #0000000000000000
	lsl	x17, x14, #4
	lsl	x7, x13, #2
	lsl	x8, x14, #2
	add	x22, x0, x9
	adrp	x24, :got:PIM_E8M0
	ldr	x24, [x24, :got_lo12:PIM_E8M0]
	add	x25, x2, x9
	adrp	x27, PIM_E2M1
	add	x27, x27, :lo12:PIM_E2M1
	str	x2, [sp, #96]                   // 8-byte Folded Spill
	stp	x12, x10, [sp, #16]             // 16-byte Folded Spill
	str	x1, [sp, #8]                    // 8-byte Folded Spill
	b	.LBB3_5
.LBB3_3:                                //   in Loop: Header=BB3_5 Depth=1
	ldr	s2, [x24, x12, lsl #2]
	fmul	v1.4s, v1.4s, v2.s[0]
	.p2align	4, , 8
.LBB3_4:                                //   in Loop: Header=BB3_5 Depth=1
	fadd	v1.4s, v1.4s, v0.4s
	ldr	x10, [sp, #24]                  // 8-byte Folded Reload
	ldp	x15, x9, [sp, #88]              // 16-byte Folded Reload
	ldp	x1, x12, [sp, #8]               // 16-byte Folded Reload
	dup	v2.4s, v1.s[1]
	dup	v3.4s, v1.s[2]
...
.LBB3_5:                                // =>This Loop Header: Depth=1
	...
	stp	x22, x15, [sp, #80]             // 16-byte Folded Spill
...
.LBB3_7:                                //   in Loop: Header=BB3_5 Depth=1
	ldp	x9, x25, [sp, #64]              // 16-byte Folded Reload
...
.LBB3_28:                               //   Parent Loop BB3_5 Depth=1
	...
	lsr	x10, x10, #4
	add	x10, x27, x10, lsl #2
	ldr	s2, [x27, x21, lsl #2]
	and	x21, x23, #0xf
	ld1	{ v2.s }[1], [x10]
	add	x10, x27, x21, lsl #2
	lsr	x21, x23, #4
	ld1	{ v2.s }[2], [x10]
	add	x10, x27, x21, lsl #2
	ld1	{ v2.s }[3], [x10]
...
// %bb.35:                              //   in Loop: Header=BB3_16 Depth=2
	...
	cmp	w15, #4
	b.lt	.LBB3_39
// %bb.36:                              //   in Loop: Header=BB3_16 Depth=2
	mov	x3, xzr
	mov	x20, x22
...
.LBB3_37:                               //   Parent Loop BB3_5 Depth=1
	...
	fmla	v1.4s, v2.4s, v3.4s
	b.lo	.LBB3_37
// %bb.38:                              //   in Loop: Header=BB3_16 Depth=2
	mov	w3, w3
	cmp	w3, w15
	b.lt	.LBB3_40
	b	.LBB3_42
	.p2align	4, , 8
.LBB3_39:                               //   in Loop: Header=BB3_16 Depth=2
	mov	x3, xzr
	cmp	w3, w15
	b.ge	.LBB3_42
...
.LBB3_41:                               //   Parent Loop BB3_5 Depth=1
	...
	fmla	v1.4s, v3.4s, v2.s[0]
	b.lo	.LBB3_41
.LBB3_42:                               //   in Loop: Header=BB3_16 Depth=2
	ldr	s2, [x24, x2, lsl #2]
	fmul	v1.4s, v1.4s, v2.s[0]
.LBB3_43:                               //   in Loop: Header=BB3_16 Depth=2
	orr	x11, x12, #0x3
	ldrb	w2, [x30, x11]
	cmp	x2, #255
	b.eq	.LBB3_15
// %bb.44:                              //   in Loop: Header=BB3_16 Depth=2
	msub	w10, w11, w14, w4
	cmp	w10, w6
	csel	w15, w10, w6, lt
	cmp	w15, #4
	b.lt	.LBB3_48
// %bb.45:                              //   in Loop: Header=BB3_16 Depth=2
	mov	x3, xzr
	mov	x20, x25
...
.LBB3_46:                               //   Parent Loop BB3_5 Depth=1
	...
	fmla	v1.4s, v2.4s, v3.4s
	b.lo	.LBB3_46
// %bb.47:                              //   in Loop: Header=BB3_16 Depth=2
	mov	w3, w3
	cmp	w3, w15
	b.ge	.LBB3_14
	b	.LBB3_49
	.p2align	4, , 8
.LBB3_48:                               //   in Loop: Header=BB3_16 Depth=2
	mov	x3, xzr
	cmp	w3, w15
	b.ge	.LBB3_14
.LBB3_49:                               //   in Loop: Header=BB3_16 Depth=2
	ldr	x10, [sp, #104]                 // 8-byte Folded Reload
	nop
	madd	x11, x11, x13, x28
	add	x19, x10, x3, lsl #2
	.p2align	4, , 8
.LBB3_50:                               //   Parent Loop BB3_5 Depth=1
                                        //     Parent Loop BB3_16 Depth=2
                                        // =>    This Inner Loop Header: Depth=3
	lsr	w10, w3, #1
	tst	x3, #0x1
...
// %bb.58:                              //   in Loop: Header=BB3_5 Depth=1
	...
	mov	x9, x11
	.p2align	4, , 8
.LBB3_59:                               //   Parent Loop BB3_5 Depth=1
                                        // =>  This Inner Loop Header: Depth=2
	ldrb	w10, [x26, x9]
	ldrb	w19, [x0, x9]
	add	x9, x9, #2
...
.LBB3_62:                               //   in Loop: Header=BB3_5 Depth=1
	...
	add	x2, x2, x10
	.p2align	4, , 8
.LBB3_63:                               //   Parent Loop BB3_5 Depth=1
                                        // =>  This Inner Loop Header: Depth=2
	lsr	w10, w9, #1
	tst	x9, #0x1
	ldr	q3, [x2], #4
